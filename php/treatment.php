      ...
      <div class="dashboard-nav">
         ...
         <div class='dashboard-app'>
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title"><b>Click at table if want to edit and delete treatment</b></h3>
                    ...
                    <tr class="expandable-body d-none">
                      <td align="center" colspan="5">
                       <p style="display: none;">
                        ...
                        <input type="button" value="updtreat" onClick="updtreat(<?php echo $row_rs['treatmentID']; ?>)">
                        </p>
                      </td>
                    </tr>
                 </tbody>
