...
<input type="text" class="form-control" id="patientIC" name="patientIC" placeholder="Enter patient IC">
</div>
<div class="form-group">
<label for="patientName">PATIENT FULL NAME</label>
<input type="text" class="form-control" id="patientName" name="patientName" placeholder="Enter patient full name">
</div>
<div class="form-group">
<label for="patientAge">PATIENT AGE</label>
<input type="text" class="form-control" id="patientAge" name="patientAge" placeholder="Enter patient age">
</div>
<div class="form-group">
...
<input type="text" class="form-control" id="patientPhoneNumber" name="patientPhoneNumber" placeholder="Enter patient phone number">
</div>
<div class="form-group">
<label for="patientAddress">PATIENT ADDRESS</label>
<input type="text" class="form-control" id="patientAddress" name="patientAddress" placeholder="Enter patient address ">
</div>
